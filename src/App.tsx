    ...
    <div className="flex justify-center align-center flex-col">
      ...
      <div className="bg-gray-900">
        <div className="flex flex-wrap mx-auto max-w-[1200px] p-4 mt-6 mb-8 gap-12 md:gap-8 justify-center md:justify-around items-center">
          <button onClick={() => window.open(t("cta.purchase"), "_blank")} className="inline-flex items-center justify-center h-18 w-[300px] text-[24px] leading-[1.2] bg-brand-600 text-white hover:bg-brand-900 cursor-pointer dark:text-white uppercase font-bold py-2 px-4 rounded-2xl">
              {t("cta.buy")}
            </button>
